package components.control.central.product
{
	...
	public class GetRegionCommand implements ICommand, IResponder
	{
		...
		{
			model.centralModel.acRegion = data.result;
		}
		
		public function fault(info:Object):void
		{
			Alert.show("Se produjo un error al buscar las regiones.","Error.");
		}
